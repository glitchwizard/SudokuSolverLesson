...
The project files generated will have starter content as outlined in the Epicodus JavaScript course. The template will give relevant namespaces and paths for your project (i.e. SudokuSolver will be replaced everywhere with the name you give to your project - YourProjectName).
...
```
dotnet new --install [ /Users/Your/Path/Here ]/SudokuSolver
```
For example: When cloned to the Epicodus computer Desktop, the path would be /Users/Guest/Desktop/SudokuSolver.  

The above command would then be:
```
dotnet new --install /Users/Guest/Desktop/SudokuSolver
```
...
```
dotnet new SudokuSolver -n [ YourProjectName ]
```
For example: If your project is called Banana the command would be:
```
dotnet new SudokuSolver -n Banana
```
